...
class StrategyOne:
    ...
    def set_data(self):
        self.handler.set_data(self.binance_api.get_24h_1h_candle(self.pair),
                              self.binance_api.get_market_depth(self.pair))
    ...
    def evaluate_criterias(self):
        ...
        result_list.append(self.criterias.criteria_2())  # 2 / 2
